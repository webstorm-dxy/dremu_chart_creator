    ...
    return <Form className="overflow-auto">
        <Form.Item label="操作">
            <Button.Group>
                ...
                <Popover title="编辑" open={open.edit} content={<EditBPMForm bpm={bpm} index={selected} setOpen={setOpen}/>} onOpenChange={newOpen => setOpen({edit: newOpen})} destroyTooltipOnHide trigger='click'>
                    <Button>编辑</Button>
                </Popover>
